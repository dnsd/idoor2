...
const double MAX_SPEED = 300.0; //フィルタを更新するorしないのしきい値（mm）//6.0m/s
const double MIN_SPEED = 15.0; //0.15m/s
const double V_MAX_TH = 6000.0; //3000mm/s以上で移動する人は観測しない
