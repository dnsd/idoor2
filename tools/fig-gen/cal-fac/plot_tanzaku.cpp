...
void display(void)
{
    ...
    glLineWidth(1.0);
    glBegin(GL_LINE_LOOP);
    glVertex3d(0.0, 0, -SENSOR_HEIGHT);
    glVertex3d(0.0, -DOOR_WIDTH, -SENSOR_HEIGHT);
    glVertex3d(0.0, -DOOR_WIDTH, -SENSOR_HEIGHT+DOOR_HEIGHT);
    glVertex3d(0.0, 0, -SENSOR_HEIGHT+DOOR_HEIGHT);
    glEnd();
    glColor3d(0.0, 0.0, 0.0);
    glLineWidth(1.0);
    glBegin(GL_LINE_LOOP);
    glVertex3d(0.0, -100, -SENSOR_HEIGHT+100.0);
    glVertex3d(0.0, -DOOR_WIDTH+100.0, -SENSOR_HEIGHT+100.0);
    glVertex3d(0.0, -DOOR_WIDTH+100.0, -SENSOR_HEIGHT+DOOR_HEIGHT-100.0);
    glVertex3d(0.0, -100, -SENSOR_HEIGHT+DOOR_HEIGHT-100.0);
    glEnd();
    // ドア（右側）
    glColor3d(0.0, 0.0, 0.0);
    glLineWidth(1.0);
    ...
    glLineWidth(1.0);
    glBegin(GL_LINE_LOOP);
    glVertex3d(0.0, 100, -SENSOR_HEIGHT+100);
    glVertex3d(0.0, DOOR_WIDTH-100, -SENSOR_HEIGHT+100);
    glVertex3d(0.0, DOOR_WIDTH-100, -SENSOR_HEIGHT+DOOR_HEIGHT-100);
    glVertex3d(0.0, 100, -SENSOR_HEIGHT+DOOR_HEIGHT-100);
    glEnd();
